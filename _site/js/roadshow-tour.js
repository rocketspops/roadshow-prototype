  ...
  var tour = new Tour({
    ...
    { // Step 1
      content: "<p>Dave Castleton provides an overview of the CMM Campaign Details page.</p>" +
               "<audio id='step-1-audio' src='/prototypes/audio/01_overview.wav' controls></audio>",
      orphan: true,
      title: "Introduction",
      onShown: function() {
    ...
    { // Step 2
      ...
      content: "<p>The Dashboard will help you see spend allocations, flights and issues with delivery or performance.</p>" +
                "<audio id='dashboard-audio' src='/prototypes/audio/02a_dashboard.wav' controls></audio>",
      element: "#graphs",
      placement: "bottom",
    ...
    { // Step 4
      ...
      content: "<p>Clicking on a graph will filter your tactics to show only those associated with your selection.</p>" +
                "<audio src='/prototypes/audio/02b_dashboard.wav' controls></audio>",
      element: "#plan-body",
      placement: "top",
    ...
    { // Step 6
      ...
      content: "<p>" +
               ...
               "</p>" +
               "<audio src='/prototypes/audio/03_vendor_search.wav' controls></audio>",
      element: "#research",
      placement: "bottom",
    ...
    { // Step 8
      ...
      content: "<p>" +
                 ...
                 "stored in one place." +
               "</p>" +
               "<audio id='step-8-audio' src='/prototypes/audio/04_message_center.wav' controls></audio>",
      element: "#messages",
      placement: "bottom",
    ...
    { // Step 9
      content: "<p>The Plans Tab is where you’ll see all your tactics, manage plan versions, and create client proposals.</p>" +
               "<audio src='/prototypes/audio/05a_plans_tab.wav' controls></audio>",
    ...
    { // Step 10
      content: "<p>In CMM, you can create as many Plan versions as you’d like.</p>" +
               "<audio src='/prototypes/audio/05b_plan_versions.wav' controls></audio>",
    ...
    { // Step 12
      content: "<p>" +
               ...
               "</p>" +
               "<audio src='/prototypes/audio/06_rfp_select_vendors.wav' controls></audio>",
      element: "#rfp-modal",
      placement: "left",
      title: "Send RFP",
      onPrev: function() {
    ...
    { // Step 13
      content: "<p>Select contacts, set budgets, adjust the RFP details, attach zip lists all right here.</p>" +
               "<audio src='/prototypes/audio/07_rfp_show_details_original.wav' controls></audio>",
      element: "#rfp-panel",
      placement: "right",
    ...
    { // Step 14
      ...
      content: "<p>Once you send off an RFP, it will be saved in the message center for later reference.</p>" +
               "<audio id='step-14-audio' src='/prototypes/audio/08_rfp_saved_in_message_center.wav' controls></audio>",
      element: "#messages",
      placement: "bottom",
    ...
    { // Step 16
      ...
      content: "<p>" +
               ...
               "</p>" +
               "<audio id='step-16-audio' src='/prototypes/audio/09_message_center_filter_rfp_responses.wav' controls></audio>",
      element: "#messages",
      placement: "bottom",
    ...
    { // Step 18
      content: "<p>" +
               ...
               "</p>" +
               "<audio src='/prototypes/audio/10_send_io.wav' controls></audio>",
      element: "#io-modal",
      placement: "left",
      title: "Submit IOs",
      onPrev: function() {
    ...
    { // Step 20
      content: "<p>" +
               ...
               "</p>" +
               "<audio src='/prototypes/audio/11_ad_server_export.wav' controls></audio>",
    ...
    { // Step 21
      content: "<p>" +
               ...
               "</p>" +
               "<audio src='/prototypes/audio/12_analytics_tab.wav' controls></audio>",
    ...
    { // Step 22
      content: "<p>" +
                 ...
                 "each user’s needs." +
               "</p>" +
               "<audio src='/prototypes/audio/13_column_settings.wav' controls></audio>",
    ...
    { // Step 24
      ...
      content: "<p>" +
               ...
               "</p>" +
               "<audio id='dashboard-audio' src='/prototypes/audio/14_analytics_dashboard.wav' controls></audio>",
      element: "#graphs",
      placement: "bottom",
